...
public class BloodTypeCompatibilityTest2 {
    ...
    public static void main(String[] args) {
        ...
        //NOW THE USER HAVE TO IMPUT A VALID NUMBER BETWEEN 1 AND 2, IN THIS EXAMPLE 1
        ...
        //THE USER INPUT 1 SO JAVA WILL EXECUTE THIS BLOCK
        if(optionBlood==1){
            ...
            switch (bloodType) {
                ...
                //JAVA WILL EXECUTE THE STATEMENT BELLOW BECAUSE THE USERS INPUT AB+ IN BLOODTYPE ABOVE
